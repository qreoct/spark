...
describe('SoloInput Component', () => {
  test('renders question with default props', () => {
  ...
  test('interaction with buttons and reflection textarea', () => {
    const displayToast = jest.fn();
    const submitHandler = jest.fn();
    render(<SoloInput 
      data={mockQuestions[0]}
  ...
  test('renders picture card', async () => {
    const displayToast = jest.fn();
    const submitHandler = jest.fn();
    render(<SoloInput 
  ...
  test('interactions with picture card and reflection textarea', async () => {
    const displayToast = jest.fn();
    const submitHandler = jest.fn();
    render(<SoloInput 
      data={mockQuestionWithPic}
